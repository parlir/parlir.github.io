...
There's a strong feeling of freedom when use a lisp. I never have a feeling when using lisp that I'm limited by my language. If I want something I make it.
...
You want to assign a variable the results of an evaluation of a conditional?
...
And you could assign this to a variable or pass it into a function (because this evaluation is ultimately just yielding a value)
...
REPL[Read-Eval-Print-Loop] based development is at the core of the dev experience with LISP. It allows immediate feedback and an interactive experience where you write out code then immediatly use that code in the repl. This tight feedback loop adds significantly to productivity I'm not waiting on a compiler to spit out some artifact that I run. I immediatly am able to access the code that I write.
